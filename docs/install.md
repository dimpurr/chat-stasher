...
`apps/extension/entrypoints/background.ts:502-509`).
...
- **🔴 Turning on backfill still does not mean every platform's history will
  ...
  **in the claude.ai page**, over the same channel the backfill fetches through,
  ...
  (`apps/extension/lib/backfill/claude-page.ts:68-173`). 🔴 **A Claude backfill
  ...
  (`apps/extension/entrypoints/background.ts:1395-1475`). Perplexity now lists
