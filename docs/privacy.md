...
| `cs_backfill_targets_v1`, `cs_backfill_tabs_v1` | Which site/tab the backfill timer should wake up for | `apps/extension/lib/backfill/alarm.ts:216`; `apps/extension/lib/backfill/tab-port.ts:170` |
...
- **On claude.ai the scope is not read from a response body: it is the
  ...
  **in the claude.ai page**, over the channel the backfill already uses, and only
  ...
  (`apps/extension/lib/backfill/alarm.ts:813-882`;
  ...
  (`apps/extension/lib/backfill/alarm.ts:800-810, 846-882`;
