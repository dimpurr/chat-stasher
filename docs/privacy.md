...
- **On claude.ai the scope is not read from a response body: it is the
  ...
  **in the claude.ai page**, over the channel the backfill already uses, and only
  ...
  organization that does not exist (`apps/extension/lib/backfill/engine.ts:1471-1483`).
  ...
  (`apps/extension/lib/backfill/alarm.ts:753-816`;
  ...
  (`apps/extension/lib/backfill/alarm.ts:781-816`;
  `apps/extension/lib/popup-view.ts:1612-1674`).
...
(`apps/extension/lib/backfill/engine.ts:2080-2090`). That produces a request pattern
...
(`apps/extension/lib/backfill/enumerate.ts:4343-4370`;
`apps/extension/lib/backfill/engine.ts:2095-2147`.) The
...
(`apps/extension/lib/backfill/enumerate.ts:3393-3521`; `apps/extension/lib/backfill/engine.ts:2095-2147`).
...
half-there (`apps/extension/lib/backfill/engine.ts:2383-2396`). Grok
...
(`apps/extension/lib/backfill/engine.ts:1573-1620`). And because no source says
