...
is, the conversation itself (`apps/extension/entrypoints/background.ts:143-171`;
...
- The `<scope>` part of that key is your **account identifier on that platform**
  ...
  (`apps/extension/entrypoints/background.ts:1077-1120` — the identity itself is
  read by `apps/extension/lib/contract.ts:1053-1069`; the `default` fallback is on
  the `||` at `apps/extension/entrypoints/background.ts:1120`). It is used to
  ...
  (`apps/extension/entrypoints/background.ts:919-940`, `:990-1064`).
- **On claude.ai the scope is not read from a response body: it is the
  ...
  **in the claude.ai page**, over the channel the backfill already uses, and only
  ...
  `apps/extension/entrypoints/background.ts:878-922`). A record an **earlier**
  ...
  (`apps/extension/entrypoints/background.ts:1224-1285`). A backfill for a *second*
  ...
  `apps/extension/entrypoints/background.ts:744-774`). Collapsing a title cannot
  ...
  (`apps/extension/lib/backfill/alarm.ts:367-431`;
  `apps/extension/entrypoints/background.ts:1224-1285`). The host archive is
  ...
  (`apps/extension/lib/backfill/alarm.ts:395-431`;
  `apps/extension/lib/popup-view.ts:1585-1647`).
