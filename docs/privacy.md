...
- The `<scope>` part of that key is your **account identifier on that platform**
  ...
  (`apps/extension/entrypoints/background.ts:850-946`).
- **On claude.ai the scope is not read from a response body: it is the
  ...
  **in the claude.ai page**, over the channel the backfill already uses, and only
  ...
  `apps/extension/entrypoints/background.ts:809-869`). The sentinel
  ...
  organization that does not exist (`apps/extension/lib/backfill/engine.ts:1289-1301`).
...
(`apps/extension/lib/backfill/engine.ts:606`). That produces a request pattern
...
(`apps/extension/lib/backfill/engine.ts:89-92`).
...
`apps/extension/lib/backfill/engine.ts:1865-1917`.) The
...
(`apps/extension/lib/backfill/enumerate.ts:3344-3472`; `apps/extension/lib/backfill/engine.ts:1865-1917`).
...
half-there (`apps/extension/lib/backfill/engine.ts:1969-2004`). Grok
...
(`apps/extension/lib/backfill/engine.ts:1391-1438`). And because no source says
