...
(`apps/extension/lib/backfill/engine.ts:1667-1676`, `:2153-2157`), which produces a
...
7. **Browser-side history backfill runs on seven platforms, recovers text on
   ...
   **ChatGPT**, **DeepSeek**, **Gemini**, **Grok**, **Kimi** and **Claude**
   ...
   rather than archived (`apps/extension/lib/backfill/engine.ts:2459-2472`).
   ...
   `apps/extension/lib/backfill/engine.ts:2259-2299`). On
