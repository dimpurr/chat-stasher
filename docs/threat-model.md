...
(`apps/extension/lib/backfill/engine.ts:1455-1521`, `:1882-1904`), which produces a
...
7. **Browser-side history backfill runs on seven platforms, recovers text on
   ...
   **ChatGPT**, **DeepSeek**, **Gemini**, **Grok**, **Kimi** and **Claude**
   ...
   `apps/extension/lib/backfill/engine.ts:2095-2147`). On
