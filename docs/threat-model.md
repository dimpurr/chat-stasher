...
(`apps/extension/lib/backfill/engine.ts:1765-1774`, `:2307-2311`), which produces a
...
7. **Browser-side history backfill runs on seven platforms, recovers text on
   ...
   **ChatGPT**, **DeepSeek**, **Gemini**, **Grok**, **Kimi** and **Claude**
   ...
   rather than archived (`apps/extension/lib/backfill/engine.ts:2613-2626`).
   ...
   `apps/extension/lib/backfill/engine.ts:2413-2453`). On
