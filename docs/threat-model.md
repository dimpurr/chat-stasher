...
7. **Browser-side history backfill runs on seven platforms, recovers text on
   ...
   **ChatGPT**, **DeepSeek**, **Gemini**, **Grok**, **Kimi** and **Claude**
   (`apps/extension/lib/backfill/enumerate.ts:3866-3893`), but on none of them
   ...
   rather than truncated (`apps/extension/lib/backfill/enumerate.ts:3529-3549`).
   ...
   (`apps/extension/lib/backfill/enumerate.ts:2215-2242`, `:3321-3377`). Grok and Claude are the least
   ...
   **none of them** (`apps/extension/lib/backfill/enumerate.ts:3866-3893`). The user-visible symptom of
