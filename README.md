...
- **Captured conversations are plaintext until they are delivered.** A live
  ...
  `apps/extension/entrypoints/background.ts:267-284`). A delivery the host never
