...
| Gemini | 🟡 Implemented, not verified | 🟡 Implemented, not verified |
| Grok | 🟡 Implemented, not verified | 🟡 Implemented, not verified |
| Kimi | 🟡 Implemented, not verified | 🟡 Implemented, not verified |
...
- **Captured conversations are plaintext until they are delivered.** A live
  ...
  `apps/extension/entrypoints/background.ts:193-210`). A delivery the host never
