...
(`crates/chat-stasher/src/main.rs:4170-4183`); without it, an unattended
...
it does anything else (`crates/chat-stasher/src/main.rs:4206-4230`). An
...
to `~/.ssh/known_hosts` (`crates/chat-stasher/src/main.rs:4185-4194`;
...
silently doing nothing (`crates/chat-stasher/src/main.rs:4173-4181`).
